...
# Created by write_sdc on Sat Oct 24 15:29:50 2020
...
set_input_delay -clock MY_CLK  -max 0.05  [get_ports {A1[7]}]
...
set_input_delay -clock MY_CLK  -max 0.05  [get_ports {B1[7]}]
...
set_input_delay -clock MY_CLK  -max 0.05  [get_ports {B0[7]}]
