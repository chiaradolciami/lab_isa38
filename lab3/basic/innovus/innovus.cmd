...
#  Created on Sat Feb 20 14:24:16 2021                
#                                                     
#######################################################
...
saveDesign RiscV_Design_Route.enc
getDrawView
setDrawView fplan
win
dumpToGIF ./ss_Snapshot.fplan.gif
getDrawView
setDrawView amoeba
win
dumpToGIF ./ss_Snapshot.amoeba.gif
getDrawView
setDrawView place
win
dumpToGIF ./ss_Snapshot.place.gif
...
encMessage debug 0
encMessage info 0
restoreDesign /home/isa38/Desktop/RISCV/innovus/RiscV_Design_Route.enc.dat RiscV
setDrawView fplan
...
read_activity_file -format VCD -scope /tb/UUT -start {} -end {} -block {} ../vcd/myRiscV.vcd
set_power -reset
set_powerup_analysis -reset
set_dynamic_power_simulation -reset
report_power -rail_analysis_format VS -outfile .//RiscV.rpt
report_power -outfile Report_power_innovus -sort { total }
